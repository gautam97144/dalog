...
import 'package:dalog_distribution/view/pages/home/open_job/dialog.dart';
...
class OpenJob extends StatelessWidget {
  OpenJob({Key? key}) : super(key: key);

  ImageDetail? imageDetail;
  int _currentStep = 0;

  ValueNotifier isSelected = ValueNotifier(true);
        ...
        children: [
          ...
          CancelButton(
              ...
              onPressed: () => CustomDialog.dialogShow(context,
                  children: [cancelDialog(context)])),
          SizedBoxH14(),
          Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            InkWell(
              onTap: () => CustomDialog.dialogShow(context, children: [
                confirmDelivery(
                  heading: "Confirm Delivery",
                  data:
                      "Go with any one option, first compare image with actual delivered items otherwise put your signature for delivery confirmation",
                  confirmMethodOne: confirmDeliveryMethodBox(context,
                      data: "Verify by Image", onPressed: () {
                    CustomDialog.dialogShow(context, children: [
                      confirmDelivery(
                          heading: "Confirm by Images",
                          data:
                              "Let’s verifiy Compare image with actual delivered items",
                          confirmMethodOne: SizedBox(
                            height: Sizes.s200.h,
                  ...
                  confirmMethodTwo:
                      confirmDeliveryMethodBox(context, onPressed: () {
                    CustomDialog.dialogShow(context, children: [
                      confirmDelivery(
                        heading: "Confirm by Signature",
                        data:
                            "Let’s  draw your signature for delivery confirmation",
                        confirmMethodOne: SizedBox(
                          height: Sizes.s200.h,
                  ...
                  }, data: "Verify by Signature"),
                )
              ]),
              child: appText("Edit Job",
  ...
  Widget confirmDeliveryMethodBox(BuildContext context,
      {String? data, VoidCallback? onPressed}) {
    return GestureDetector(
      onTap: onPressed,
      child: Padding(
        padding: EdgeInsets.only(bottom: Sizes.s10.h),
        child: Container(
          ...
          decoration: BoxDecoration(
              color: Theme.of(context).brightness ==
                      ThemeUtils.darkTheme.brightness
                  ? AppColor.lightPrimaryColorDarkTheme
                  : AppColor.lightGrey,
              borderRadius: BorderRadius.circular(borderRadius)),
          child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
